...
%Where the agents could bring about an outcome in several different, equally good ways,
%having some agents each individually plan all of the agents' actions is probably not useful.
Consider housemates
...
%If  each agent also  knows enough about herself and the others to be able to determine, without communicating, whether her plan and role assignments will be acceptable to everyone, then
% it need not be irrational for the agents each individually to plan all of the agents' actions. 
