...
In this chapter we consider what infants understand of action.
...
Are there alternative views of action understanding which do not demand knowledge of intentions?
...
This view of action understanding requires less conceptual sophistication thanks to not requiring knowledge of intentions as such. 
But remains quite demanding, for it entails that one-year-olds  are able to justify actions and engage in means end reasoning.
...
So far we have ignored the possibility that motor representations and processes may play a role in understanding action.
...
(This is surely not the whole story, but it can be extended to involve statistical learning as well as motor representation; see \citet{paulus:2011_role}, \citet{Baldwin:2001rn}, and \citet{Saylor:2007pj}.)
