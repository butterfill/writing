...
%*** remove this line: to avoid annoying error only
\
...
For instance, she must associate the pointing gesture with the object indicated; or, if (say) she is looking for an individual she must associate an utterance of `daddy' with the appropriate person.%
\footnote{
...
How might this work?
***sketch the story***
Clearly this is a wild conjecture,
and not one that we have given any reason for accepting.
Our point in mentioning it is merely to illustrate how
 better understanding the role of interaction in goal ascription and mindreading generally
may eventually lead to discoveries
on how
 sophisticated forms of cognition
 emerge from
 conceptually and cognitively undemanding forms of interaction.
If the culture of tool use,
the simpler forms of communicative gesture
or the sharing of knowledge and other mental states
originates in abilities to interact,
then we need to know how interaction could lead to the emergence of these things.
Our  suggestion has been that
understanding how interacting mindreaders 
could know things about their minds which mere observers might not be in a position to know
