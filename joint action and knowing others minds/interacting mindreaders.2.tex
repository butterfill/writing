...
This paper defends a positive answer.
...
on which
all the evidence relevant to mindreading 
...
The problem is potentially a problem for mindreaders given the standard, purely observational models of mindreading.
It is not our intention to suggest that the problem of opaque means is a problem \emph{for models of mindreading}.
Rather, it is a potential problem \emph{for mindreaders}.

That the problem of opaque means exists
is the first premise in our argument
that models of mindreading based on pure observation are less powerful than models taking into account the possibility of interaction.
