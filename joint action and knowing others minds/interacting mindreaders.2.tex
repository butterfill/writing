...
in which participants had to find a reward 
and were helped either by a failed reach or by a helpful point to the target location.
Strikingly, for chimpanzees the helpful point is no help at all---even though it superficially resembles the failed reach, which occurred first and did help.
...
could be part of what enables mindreaders to make the transation from 
