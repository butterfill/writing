...
in principle the same evidence could be available to each, and each can exploit the same routes to knowledge in moving from evidence to ascriptions of thought and action.
