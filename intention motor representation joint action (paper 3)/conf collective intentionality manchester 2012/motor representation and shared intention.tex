...
\section{***REFRAME***}
Shouldn't start with the question, Which events are joint actions?  Instead: either it's about making sense of purposive joint action, or else it's the question about the relation between purposive joint actions and the goals to which they are directed.
(Was just trying to make it sound more important by asking Which events are joint actions.  But I don't think this question bears any weight.)
...
%Suppose that the purposiveness of some actions really is grounded in motor representation in the way just described.
